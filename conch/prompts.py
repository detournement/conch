...
_CHAT_BASE = (
    ...
    "- search_conversations: search all past conversations for topics, commands, or "
    "information discussed previously. Use when the user asks 'what did we talk about', "
    "'find that conversation where...', 'what was the command for...', etc.\n"
